...
Members who do not donate the minimum amount for door access
have access to Labitat when others let them in.
See [door access](https://labitat.dk/wiki/Door_access) for the minimum donation required.
...
* Do not harass people.
  Stalking, unconsented physical contact,
  unwanted sexual attention, physical violence,
  narcissistic behaviour, or mental violence
  is harassment.
...
Remember that assholes can only remain assholes
if their entourage enables it by not saying no to their behaviour.
...
then feel free to email conduct@labitat.dk.
